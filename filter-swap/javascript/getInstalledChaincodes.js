...
async function main() {
    ...
    }).example('node getIntalledChaincodes -a admin -c connection-org1.json')
        .version(false)
        .argv;
    ...
    try {
        ...
        for(let peer of peers){
            console.log('Installed chaincodes for ' + peer.getName());
            let installedChaincodes = await client.queryInstalledChaincodes(peer,true);
