...
const Asset = require('./MaintenanceAsset.js');

class MaintenanceAssetList extends StateList {

    constructor(ctx) {
        super(ctx, 'org.biss.maintenanceassetlist');
        this.use(Asset);
    }
...
module.exports = MaintenanceAssetList;
